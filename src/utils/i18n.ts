...
export const TRANSLATIONS: Record<string, { en: string; ar: string }> = {
  ...
  'nav.accounts': { en: 'SoftPOS', ar: 'نقطة البيع' },
  'nav.pay': { en: 'Pay Links', ar: 'روابط الدفع' },
  'nav.scan': { en: 'ZATCA QR', ar: 'رمز QR' },
  ...
  'merchant.authorizing_sama': { en: 'Authorizing with Banking Network...', ar: 'جاري التفويض مع شبكة الدفع...' },
  ...
  'cards.digital_mada': { en: 'Digital Debit Card (Apple Pay & Cards)', ar: 'بطاقة الدفع الرقمية (أبل باي والبطاقات)' },
  ...
  'cards.saved_cards': { en: 'Saved Debit & Credit Cards', ar: 'البطاقات البنكية والائتمان المحفوظة' },
  ...
  'mada POS Payment': { en: 'Debit Card POS Payment', ar: 'عملية نقاط بيع بالبطاقة' },
  ...
  'mada Contactless': { en: 'Card Contactless', ar: 'بطاقة بنكية لا تلامسية' },
  ...
  'services.help': { en: 'Support & Helpdesk', ar: 'الدعم والمساعدة الرسمية' },
  ...
  'insights.busiest_vol': { en: 'Busiest Hour Volume', ar: 'حجم ساعة الذروة' },
  'insights.avg_tap_speed': { en: 'Avg Tap-to-Pay Speed', ar: 'سرعة الدفع بالبطاقة' },
  'insights.todays_collections': { en: "Today's Collections", ar: 'مقبوضات اليوم' },
  ...
  'insights.cards_tap': { en: 'Debit & Cards (Tap to Pay)', ar: 'البطاقات البنكية (أثير)' },
  'insights.apple_pay': { en: 'Apple Pay & Wallets', ar: 'أبل باي والمحافظ' },
  'insights.zatca_qr': { en: 'ZATCA Dynamic QR', ar: 'باركود هيئة الزكاة' },
